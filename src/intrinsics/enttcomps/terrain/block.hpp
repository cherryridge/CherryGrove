...
namespace EnttComps::Terrain {
    typedef uint16_t u16;
    typedef uint32_t u32;
    typedef int64_t i64;
    typedef uint64_t u64;
    using std::array, boost::unordered_flat_map, std::numeric_limits, glm::uvec2, glm::vec3, glm::vec4, TexturePool::getTextureInfo, TexturePool::TextureInfo;
