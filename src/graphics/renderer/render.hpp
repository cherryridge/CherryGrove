...
namespace Renderer {
    ...
    inline void render() noexcept {
        ...
        bgfx::setViewRect(VIEWID_GAME, 0, 0, windowInfoCache.width, windowInfoCache.height);
        ...
        //Prepare render environment
            ...
            static_cast<void>(Systems::getProjMtx(Simulation::playerEntity, windowInfoCache.aspectRatio, proj));
