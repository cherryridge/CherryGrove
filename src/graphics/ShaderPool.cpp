...
namespace ShaderPool {
    ...
    using std::string, std::ifstream, std::filesystem::file_size, std::filesystem::exists, bgfx::RendererType, bgfx::ShaderHandle, bgfx::ProgramHandle, bgfx::destroy, boost::unordered_flat_map;
