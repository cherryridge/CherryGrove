...
namespace TexturePool {
    typedef int16_t i16;
    using std::atomic, boost::unordered_flat_map, bgfx::UniformHandle, bgfx::createTexture2D, bgfx::createUniform, bgfx::setTexture, bgfx::makeRef, bgfx::UniformType, bgfx::TextureFormat, bgfx::destroy, std::move, std::numeric_limits, std::memory_order_relaxed;
