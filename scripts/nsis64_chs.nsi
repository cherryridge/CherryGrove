...
#region Branding
OutFile "..\build\x64\CherryGrove_setup_chs_x64.exe"
InstallDir "$PROGRAMFILES64\CherryGrove"
Name "CherryGrove"
Caption "CherryGrove Installer"
BrandingText "CherryGrove (c) 2024 LJM12914"

VIAddVersionKey /LANG=${LANG_SimpChinese} "ProductName" "CherryGrove"
VIAddVersionKey /LANG=${LANG_SimpChinese} "CompanyName" "LJM12914"
VIAddVersionKey /LANG=${LANG_SimpChinese} "LegalCopyright" "(c) 2024 LJM12914"
VIAddVersionKey /LANG=${LANG_SimpChinese} "FileDescription" "CherryGrove Installer"
